...
function ThinkingBubble() {
  return (
    <div className="animate-slide-in-left inline-flex items-center gap-1.5 rounded-2xl bg-white px-4 py-3.5
      shadow-sm ring-1 ring-slate-100/80 border-l-2 border-[#002D4D]/30">
      <span className="size-2 rounded-full bg-[#002D4D]/40 animate-bounce" style={{ animationDelay: '0ms' }} />
      <span className="size-2 rounded-full bg-[#FBC412]/50 animate-bounce"   style={{ animationDelay: '160ms' }} />
      <span className="size-2 rounded-full bg-[#002D4D]/40 animate-bounce" style={{ animationDelay: '320ms' }} />
    </div>
  )
}
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-5 sm:gap-7 px-4 sm:px-6 py-8 sm:py-10">
        ...
        <div className="text-center animate-slide-up">
          <div className="relative inline-flex mb-5">
            <div className="absolute inset-0 scale-[2.2] blur-2xl bg-[#002D4D]/15 rounded-full pointer-events-none" />
            <div className="size-20 rounded-2xl overflow-hidden shadow-xl shadow-[#002D4D]/20 ring-2 ring-[#C5E7FF] relative">
              <GradCapIcon className="size-20" />
            </div>
          </div>
          <h2 className="text-2xl font-bold gradient-text">Hola, soy Polaris</h2>
          <p className="text-sm text-slate-500 mt-0.5 mb-3">dejame ser tu guía, tu polaris</p>
          ...
          {SUGGESTIONS.map(({ Icon, text }, i) => (
            <button
              ...
              className="animate-fade-in flex items-center gap-3 rounded-2xl border border-slate-200 bg-white
                ...
                hover:border-[#002D4D]/30 hover:shadow-md hover:scale-[1.02] hover:-translate-y-0.5
            ...
            >
              <div className="flex size-8 shrink-0 items-center justify-center rounded-xl
                bg-[#C5E7FF]/60 text-[#002D4D] group-hover:bg-[#C5E7FF] transition-colors">
